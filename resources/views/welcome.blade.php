...
<div class="wrapper">
  <!-- Navbar -->
        <nav class="main-header navbar navbar-expand navbar-white navbar-light"  style="float: right">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
            <li class="nav-item">
  ...
  <!-- /.navbar -->
    ...
    <footer class="main-footer">
        ...
        <center><strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">Financial Guardian System</a>.</strong> All rights
        reserved.</center>
    </footer>
